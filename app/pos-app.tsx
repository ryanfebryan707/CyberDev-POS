  ...
  return <main className="login-shell">
    <section className="login-panel">
      ...
      <div className="login-form-wrap">
        ...
        {mode === "client"&&<><GoogleIdentityButton disabled={loading} loginHint={googleLoginHint||undefined} onSuccess={finishGoogleLogin}/><p className="google-registration-note">Pilih akun Google dengan email yang sama persis seperti pendaftaran Demo manual atau data yang dibuat oleh Admin. Isi email Client di atas bila ingin Google langsung memilih akun tersebut.</p></>}
