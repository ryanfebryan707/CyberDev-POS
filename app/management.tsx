...
export function SettingsView() {
  ...
  const [message,setMessage]=useState(""),[busy,setBusy]=useState(false),[google,setGoogle]=useState(false),[linked,setLinked]=useState(false);
  ...
  useEffect(()=>{
    ...
    api("/api/auth/providers").then(data=>setGoogle(data.google)).catch(()=>undefined);
  },[]);
